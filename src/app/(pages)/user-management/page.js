...
const page = () => {
  ...
  const debouncedFetch = React.useMemo(
    () => debounce(fetchUserOverview, 500),
    [payload]
  );
  ...
  return (
    <div className="px-6 py-8">
      ...
      <div className="mb-2 mt-4 flex justify-between items-center">
        ...
        {activeTab === "Access" && (
          <div className="flex items-center justify-end mt-2">
            <Button onClick={() => setNewUser(true)} className="gap-2">
              <Plus color="white" />
              Create New User
            </Button>
          </div>
            ...
            <label className="flex flex-wrap w-full">
              ...
              <Input
                ...
                onInput={(e) => {
                    ...
                    // non - numbers not allowed by regex
                  }}
                name="phone"
                required
                className="w-full border border-[#D1D1D1]"
      ...
      {activeTab === "Account management" && (
        <AccountManagementTable setPayload={setPayload} payload={payload} />
      )}
      {activeTab === "Issues" && (
        <IssuesTable payload={payload} setPayload={setPayload} />
      )}
      {/* {activeTab === 'Access' &&
                <>
