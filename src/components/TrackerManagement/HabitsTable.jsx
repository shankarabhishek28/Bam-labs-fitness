                        ...
                        >
                            ...
                            <TableCell>
                                ...
                                <div className="flex items-center justify-start gap-8">
                                    <Button onClick={() => router.push(`/user-management/issues/${item.userID}`)} className=' px-2 h-8 text-[14px] flex gap-2 w-[90px]'>
                                        <Pencil color="white" size={20} />Edit</Button><Button className='px-2 h-8 text-[14px] flex gap-2 items-center w-[90px]'><Trash2 size={20} color="white" /> Delete</Button>
                                </div>
